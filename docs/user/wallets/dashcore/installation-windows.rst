...
``dashcore-1.2.3-win64-setup.exe.asc`` in the same folder as the
...
dashcore-1.2.3-win64-setup.exe with
dashcore-1.2.3-win64-setup.exe.asc`` then you have an authentic copy
