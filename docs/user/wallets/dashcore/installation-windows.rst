...
``dashcore-2222.22.222-win64-setup.exe.asc`` in the same folder as the
...
dashcore-2222.22.222-win64-setup.exe with
dashcore-2222.22.222-win64-setup.exe.asc`` then you have an authentic copy
