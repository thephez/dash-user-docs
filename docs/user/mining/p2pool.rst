...
**Ctrl + V**::
  ...
  cd ~
  wget https://github.com/dashpay/dash/releases/download/v1.2.3/dashcore-1.2.3-x86_64-linux-gnu.tar.gz
...
::
  ...
  wget https://github.com/dashpay/dash/releases/download/v1.2.3/dashcore-1.2.3-x86_64-linux-gnu.tar.gz.asc
  gpg --verify dashcore-1.2.3-x86_64-linux-gnu.tar.gz.asc
...
copy the necessary files to the directory and set them as executable::
  ...
  mkdir ~/.dashcore
  tar xfvz dashcore-1.2.3-x86_64-linux-gnu.tar.gz
  cp dashcore-1.2.3/bin/dashd .dashcore/
  cp dashcore-1.2.3/bin/dash-cli .dashcore/

Clean up unneeded files::

  rm dashcore-1.2.3-x86_64-linux-gnu.tar.gz
  rm -r dashcore-1.2.3/
