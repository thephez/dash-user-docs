...
**Ctrl + V**::
  ...
  cd ~
  wget https://github.com/dashpay/dash/releases/download/v2222.22.222/dashcore-2222.22.222-x86_64-linux-gnu.tar.gz
...
::
  ...
  wget https://github.com/dashpay/dash/releases/download/v2222.22.222/dashcore-2222.22.222-x86_64-linux-gnu.tar.gz.asc
  gpg --verify dashcore-2222.22.222-x86_64-linux-gnu.tar.gz.asc
...
copy the necessary files to the directory and set them as executable::
  ...
  mkdir ~/.dashcore
  tar xfvz dashcore-2222.22.222-x86_64-linux-gnu.tar.gz
  cp dashcore-2222.22.222/bin/dashd .dashcore/
  cp dashcore-2222.22.222/bin/dash-cli .dashcore/

Clean up unneeded files::

  rm dashcore-2222.22.222-x86_64-linux-gnu.tar.gz
  rm -r dashcore-2222.22.222/
