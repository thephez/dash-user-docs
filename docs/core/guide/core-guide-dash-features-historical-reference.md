...
|                             | ← | [`inv` message](../ref/core-ref-p2p-network-data-messages.md#inv) (txlvote) | Masternodes in the [quorum](core-guide-dash-features-masternode-quorums#quorum-configuration) respond with votes
